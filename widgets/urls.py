...
urlpatterns = [
  ...
  path('content_volume_top_10_authors_widget/<int:pk>', views.content_volume_top_10_authors_widget, name='content_volume_top_10_authors_widget'),
  path('content_volume_top_10_countries_widget/<int:pk>', views.content_volume_top_10_countries_widget, name='content_volume_top_10_countries_widget'),
