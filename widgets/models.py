...
class WidgetDescription(models.Model):
  ...
  title_for_change = models.CharField(default='Title', max_length=50)
...
def create_widget_description(sender, instance, created, **kwargs):
  if created:
    wd1 = WidgetDescription.objects.create(title='Summary', title_for_change='Summary')
    ...
    wd1.save()
    wd2 = WidgetDescription.objects.create(title='Content volume', title_for_change='Content volume')
    ...
    wd2.save()
    wd3 = WidgetDescription.objects.create(title='Clipping feed content', title_for_change='Clipping feed content')
    ...
    wd3.save()
    wd4 = WidgetDescription.objects.create(title='Top 10 authors by volume', title_for_change='Top 10 authors by volume')
    ...
    wd4.save()
    wd5 = WidgetDescription.objects.create(title='Top 10 brands by volume', title_for_change='Top 10 brands by volume')
    ...
    wd5.save()
    wd6 = WidgetDescription.objects.create(title='Top 10 countries by volume', title_for_change='Top 10 countries by volume')
    ...
    wd6.save()
    wd7 = WidgetDescription.objects.create(title='Top 10 languages', title_for_change='Top 10 languages')
    ...
    wd7.save()
    wd8 = WidgetDescription.objects.create(title='Content Volume by Top 10 sources', title_for_change='Content Volume by Top 10 sources')
    ...
    wd8.save()
    wd9 = WidgetDescription.objects.create(title='Sentiment top 10 sources widget', title_for_change='Sentiment top 10 sources widget')
    ...
    wd9.save()
    wd10 = WidgetDescription.objects.create(title='Sentiment top 10 countries widget', title_for_change='Sentiment top 10 countries widget')
    ...
    wd10.save()
    wd11 = WidgetDescription.objects.create(title='Sentiment top 10 authors widget', title_for_change='Sentiment top 10 authors widget')
    ...
    wd11.save()
    wd12 = WidgetDescription.objects.create(title='Sentiment top 10 languages widget', title_for_change='Sentiment top 10 languages widget')
    ...
    wd12.save()
    wd13 = WidgetDescription.objects.create(title='Sentiment for period widget', title_for_change='Sentiment for period widget')
    ...
    wd13.save()
    wd14 = WidgetDescription.objects.create(title='Content Volume by Top 10 authors', title_for_change='Content Volume by Top 10 authors')
    ...
    wd14.save()
    wd15 = WidgetDescription.objects.create(title='Content Volume by Top 10 countries', title_for_change='Content Volume by Top 10 countries')
