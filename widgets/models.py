...
class WidgetDescription(models.Model):
  ...
  author_dim_pivot = ArrayField(models.CharField(max_length=30), default=None, null=True, blank=True)
  country_dim_pivot = ArrayField(models.CharField(max_length=30), default=None, null=True, blank=True)
  source_dim_pivot = ArrayField(models.CharField(max_length=30), default=None, null=True, blank=True)
  language_dim_pivot = ArrayField(models.CharField(max_length=30), default=None, null=True, blank=True)
  sentiment_dim_pivot = ArrayField(models.CharField(max_length=30), default=None, null=True, blank=True)
...
def create_widget_description(sender, instance, created, **kwargs):
  if created:
    ...
    wd3.save()
    wd4 = WidgetDescription.objects.create(title='Top 10 authors by volume', default_title='Top 10 authors by volume')
    ...
    wd4.save()
    wd5 = WidgetDescription.objects.create(title='Top 10 brands by volume', default_title='Top 10 brands by volume')
    ...
    wd5.save()
    wd6 = WidgetDescription.objects.create(title='Top 10 countries by volume', default_title='Top 10 countries by volume')
    ...
    wd6.save()
    wd7 = WidgetDescription.objects.create(title='Top 10 languages', default_title='Top 10 languages')
    ...
    wd8.save()
    wd9 = WidgetDescription.objects.create(title='Sentiment top 10 sources widget', default_title='Sentiment top 10 sources widget')
    ...
    wd9.save()
    wd10 = WidgetDescription.objects.create(title='Sentiment top 10 countries widget', default_title='Sentiment top 10 countries widget')
    ...
    wd10.save()
    wd11 = WidgetDescription.objects.create(title='Sentiment top 10 authors widget', default_title='Sentiment top 10 authors widget')
    ...
    wd11.save()
    wd12 = WidgetDescription.objects.create(title='Sentiment top 10 languages widget', default_title='Sentiment top 10 languages widget')
