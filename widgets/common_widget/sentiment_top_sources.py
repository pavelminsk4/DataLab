...
def post_agregator_sentiment_top_sources(posts, top_counts):
  top_brands = posts.values('feedlink__source1').annotate(brand_count=Count('feedlink__source1')).order_by('-brand_count').values_list('feedlink__source1', flat=True)[:top_counts]
