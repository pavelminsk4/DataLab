...
class InteractiveWidgetsTestsTLW(APITestCase):
    ...
    def test_top_10_interactive_widgets(self):
        ...
        url = reverse('widgets:interactive_widgets', kwargs={
                      'project_pk': pr.pk, 'widget_pk': widget_pk})
        post1 = TalkwalkerPost.objects.all().get(entry_title='First post title').pk
        data = {
            'first_value': ['English'],
            'second_value': [],
            'dates': [],
    ...
    def test_sentiment_top_10_interactive_widgets_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='Second post title').pk
        widget_pk = pr.widgets_list_2.sentiment_top_languages_id
        url = reverse('widgets:interactive_widgets', kwargs={
                      'project_pk': pr.pk, 'widget_pk': widget_pk})
        data = {
    ...
    def test_content_volume_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='Second post title').pk
        widget_pk = pr.widgets_list_2.volume_id
        url = reverse('widgets:interactive_widgets', kwargs={
    ...
    def test_top_keywords_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='Second post title').pk
        widget_pk = pr.widgets_list_2.top_keywords_id
        url = reverse('widgets:interactive_widgets', kwargs={
    ...
    def test_sentiment_top_keywords_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='Second post title').pk
        widget_pk = pr.widgets_list_2.sentiment_top_keywords_id
        url = reverse('widgets:interactive_widgets', kwargs={
    ...
    def test_authors_by_country_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='First post title').pk
        widget_pk = pr.widgets_list_2.authors_by_country_id
        url = reverse('widgets:interactive_widgets', kwargs={
                      'project_pk': pr.pk, 'widget_pk': widget_pk})
        data = {
    ...
    def test_authors_by_sentiment_tlw(self):
        pr = Project.objects.first()
        post_id = TalkwalkerPost.objects.all().get(entry_title='First post title').pk
        widget_pk = pr.widgets_list_2.authors_by_sentiment_id
        url = reverse('widgets:interactive_widgets', kwargs={
