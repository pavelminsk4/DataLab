...
class SentimentForPeriodWidgetTestsTLW(APITestCase):
    ...
    def test_response_list_tlw(self):
        p1 = TalkwalkerPostFactory(entry_published='2021-09-03 00:00:00Z', sentiment='neutral')
        p2 = TalkwalkerPostFactory(entry_published='2022-09-03 00:00:00Z', sentiment='neutral')
        p3 = TalkwalkerPostFactory(entry_published='2021-10-03 00:00:00Z', sentiment='negative')
        p4 = TalkwalkerPostFactory(entry_published='2021-09-03 00:00:00Z', sentiment='negative')
        p5 = TalkwalkerPostFactory(entry_published='2022-09-03 00:00:00Z', sentiment='positive')
        p6 = TalkwalkerPostFactory(entry_published='2022-10-03 00:00:00Z', sentiment='neutral')
        p7 = TalkwalkerPostFactory(entry_published='2023-09-03 00:00:00Z', sentiment='neutral')
        p8 = TalkwalkerPostFactory(entry_published='2023-09-03 00:00:00Z', sentiment='neutral')
        pr = ProjectFactory()
        for post in (p1, p2, p3, p4, p5, p6, p7, p8):
