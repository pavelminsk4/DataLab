...
class ContentVolumeTop10SourcesWidgetTests(APITestCase):
  def test_response_list(self):
    ...
    pr1 = Project.objects.create(title='Project1', keywords=['post'], additional_keywords=[], ignore_keywords=[], start_search_date=datetime(2021, 8, 10), 
                                end_search_date=datetime(2021, 10, 16), country_filter='', author_filter='', language_filter='', creator=user)
