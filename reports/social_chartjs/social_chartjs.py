...
def screen_top_languages(driver, proj_pk):
    url = base_url + '/api/reports/0/social/top_languages_screenshot/' + str(proj_pk) + '/'
    driver.get(url)
    screenshot_path = storage_folder + 'social_top_languages_' + str(uuid4()) + '.png'
    driver.save_screenshot(screenshot_path)
    return screenshot_path
