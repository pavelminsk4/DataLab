    ...
    def convert_to_item(self):
        ...
        if project_type == 'Project':
            ...
            item = ReportItem.objects.create(
                ...
                soc_content_volume_top_locations = widget_list.content_volume_by_top_locations.is_active,
                soc_content_volume_top_authors = widget_list.content_volume_by_top_authors.is_active,
                soc_content_volume_top_languages = widget_list.content_volume_by_top_languages.is_active,
