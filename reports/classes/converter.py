    ...
    def convert_to_item(self):
        ...
        if project_type == 'Project':
            ...
            item = ReportItem.objects.create(
                ...
                onl_summary = widget_list.summary.is_active,
                ...
                onl_sentiment_top_sources = widget_list.sentiment_top_sources.is_active,
                onl_sentiment_top_countries = widget_list.sentiment_top_countries.is_active,
                onl_sentiment_top_authors = widget_list.sentiment_top_authors.is_active,
                onl_sentiment_top_languages = widget_list.sentiment_top_languages.is_active,
                onl_sentiment_for_period = widget_list.sentiment_for_period.is_active,
                onl_content_volume_top_authors = widget_list.content_volume_top_authors.is_active,
                onl_content_volume_top_countries = widget_list.content_volume_top_countries.is_active,
            ...
            item = ReportItem.objects.create(
                ...
                soc_keywords_by_location = widget_list.keywords_by_location.is_active,
                soc_languages_by_location = widget_list.languages_by_location.is_active
            )
        return item
