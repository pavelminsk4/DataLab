...
def create_summary_widget_image(project_id, widget_pk):
  ...
  I1.text((155, 53), str(res['neutral']), font=myFont, fill=(0, 0, 0))
  I1.text((290, 53), str(res['negative']), font=myFont, fill=(0, 0, 0))
  I1.text((425, 53), str(res['positive']), font=myFont, fill=(0, 0, 0))
