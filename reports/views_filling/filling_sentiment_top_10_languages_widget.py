...
def sentiment_top_10_languages_widget_image(document, proj):
  if proj.sentiment_top_10_languages_widget.is_active:
    p2 = document.add_paragraph(' Sentiment Top 10 Languages Widget', style='pTableHeaderLeft')
    ...
    document.add_picture('tmp/sentiment_top_10_languages_widget.png', width=Inches(6.6))
    document.add_paragraph('', style='pTableHeaderLeft')
    document.add_paragraph('', style='pTableHeaderLeft')
  return True
