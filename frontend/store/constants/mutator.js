export const mutator = {
  ...
  SET_LANGUAGES_BY_COUNTRY: 'SET_LANGUAGES_BY_COUNTRY',
  ...
  SET_TOP_KEYWORDS_BY_COUNTRY_WIDGET: 'SET_TOP_KEYWORDS_BY_COUNTRY_WIDGET',
  ...
  SET_FILTERS_LANGUAGES: 'SET_FILTERS_LANGUAGES',
  SET_FILTERS_COUNTRIES: 'SET_FILTERS_COUNTRIES',
  SET_FILTERS_SOURCES: 'SET_FILTERS_SOURCES',
  SET_FILTERS_AUTHORS: 'SET_FILTERS_AUTHORS',
  ...
  SET_GENDER_BY_LOCATION: 'SET_GENDER_BY_LOCATION',
  ...
  SET_LANGUAGES_BY_LOCATION: 'SET_LANGUAGES_BY_LOCATION',

  // Reports
  SET_NEW_REPORT: 'SET_NEW_REPORT',
  SET_REPORT_WIDGETS_LIST: 'SET_REPORT_WIDGETS_LIST',
  SET_WIDGETS_LISTS: 'SET_WIDGETS_LISTS',
  SET_DOWNLOADING_INSTANT_REPORT: 'SET_DOWNLOADING_INSTANT_REPORT',
  ...
  SET_TFS_TRANSLATED_ORIGINAL_CONTENT: 'SET_TFS_TRANSLATED_ORIGINAL_CONTENT',
  SET_TFS_SORT_TYPE: 'SET_TFS_SORT_TYPE',

  SET_TFS_AI_SUMMARY: 'SET_TFS_AI_SUMMARY',
  SET_TRANSLATED_AI_SUMMARY: 'SET_TRANSLATED_AI_SUMMARY',

  RESET_TFS_ITEMS: 'RESET_TFS_ITEMS',

  // Comparison
  SET_NEW_COMPARISON_WORKSPACE: 'SET_NEW_COMPARISON_WORKSPACE',
  SET_NEW_COMPARISON_PROJECT: 'SET_NEW_COMPARISON_PROJECT',
  SET_SUMMARY_WIDGETS: 'SET_SUMMARY_WIDGETS',
  SET_SUMMARY_WIDGETS_LOADING: 'SET_SUMMARY_WIDGETS_LOADING',
  SET_SENTIMENT_WIDGETS: 'SET_SENTIMENT_WIDGETS',
  SET_SENTIMENT_WIDGETS_LOADING: 'SET_SENTIMENT_WIDGETS_LOADING',
  SET_DEMOGRAPHY_WIDGETS: 'SET_DEMOGRAPHY_WIDGETS',
  SET_DEMOGRAPHY_WIDGETS_LOADING: 'SET_DEMOGRAPHY_WIDGETS_LOADING',
  SET_INFLUENCERS_WIDGETS: 'SET_INFLUENCERS_WIDGETS',
  SET_INFLUENCERS_WIDGETS_LOADING: 'SET_INFLUENCERS_WIDGETS_LOADING',

  // Expert filter
  SET_PRESETS_GROUPS: 'SET_PRESETS_GROUPS',
  SET_PRESETS_GROUP: 'SET_PRESETS_GROUP',
  REMOVE_PRESETS_GROUP: 'REMOVE_PRESETS_GROUP',
  SET_NEW_PRESETS_GROUP: 'SET_NEW_PRESETS_GROUP',

  SET_PRESETS: 'SET_PRESETS',
  SET_PRESET: 'SET_PRESET',
  REMOVE_PRESET: 'REMOVE_PRESET',
  SET_NEW_PRESET: 'SET_NEW_PRESET',

  // translation
  SET_TRANSLATION: 'SET_TRANSLATION',
  SET_PLATFORM_LANG: 'SET_PLATFORM_LANG',
}
