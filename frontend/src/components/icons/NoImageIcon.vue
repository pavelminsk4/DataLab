<template>
  ...
  >
    ...
    >
      ...
      />
      <path
        d="M 74.865 78.328 c -0.257 0 -0.513 -0.098 -0.708 -0.294 L 12.079 15.716 c -0.39 -0.391 -0.389 -1.024 0.003 -1.414 c 0.391 -0.389 1.024 -0.389 1.414 0.003 l 62.078 62.317 c 0.391 0.392 0.389 1.024 -0.002 1.414 C 75.376 78.231 75.12 78.328 74.865 78.328 z"
        style="
          stroke: white;
          stroke-width: 1;
          stroke-dasharray: none;
