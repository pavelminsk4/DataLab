...
class TestSocialExpertFilters(APITestCase):
    def test_search_with_expert_preset(self):
        ...
        aim = TweetBinderPostFactory(id=4, post_id=41111111, user_name='Elon', user_alias='', text='4', sentiment='negative',
                               date='2022-09-02T06:44:00.000Z', locationString='USA', language='Arabic', count_favorites=11, count_totalretweets=13, count_replies=1994)
