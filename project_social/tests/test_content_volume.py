...
class ContentVolumeWidgetTests(APITestCase):
  def test_response_list(self):
    ...
    TweetBinderPost.objects.create(post_id='2', count_retweets='2', count_favorites='2', count_replies='2', language='Sp', user_name='Second_name', locationString='England', sentiment_vote='positive', text='Second twitter post', creation_date=datetime(2021, 10, 10))
    ...
    res = [
            {'created_count': 1, 'creation_date': '2020-10-10T00:00:00Z'},
            {'created_count': 1, 'creation_date': '2021-10-10T00:00:00Z'}
          ]
