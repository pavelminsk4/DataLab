...
class GendeerVolumeWidgetTests(APITestCase):
  def test_response_list(self):
    ...
    TweetBinderPost.objects.create(post_id='1', count_retweets='1', count_favorites='1', count_replies='1', language='En', user_name='First_name', locationString='USA', 
                                   sentiment_vote='neutral', text='First twitter post', creation_date=datetime(2020, 10, 10), user_gender='male')
    TweetBinderPost.objects.create(post_id='2', count_retweets='2', count_favorites='2', count_replies='2', language='Sp', user_name='Second_name', locationString='England', 
                                   sentiment_vote='positive', text='Second twitter post', creation_date=datetime(2020, 10, 10), user_gender='female')
    TweetBinderPost.objects.create(post_id='3', count_retweets='1', count_favorites='1', count_replies='1', language='En', user_name='3_name', locationString='USA', 
                                   sentiment_vote='neutral', text='3 twitter post', creation_date=datetime(2021, 10, 10), user_gender='undefined')
    ...
    res = [
            {'female': [
                        {'creation_date': '2020-10-10 00:00:00+00:00', 'post_count': 1},
                        {'creation_date': '2021-10-10 00:00:00+00:00', 'post_count': 0}]},
            {'male': [
                        {'creation_date': '2020-10-10 00:00:00+00:00', 'post_count': 1},
                        {'creation_date': '2021-10-10 00:00:00+00:00', 'post_count': 0}]},
            {'undefined': [
                            {'creation_date': '2020-10-10 00:00:00+00:00', 'post_count': 0},
