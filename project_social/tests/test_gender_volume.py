...
class GendeerVolumeWidgetTests(APITestCase):
  def test_response_list(self):
    TweetBinderPostFactory(date='2020-10-10 00:00:00+00:00', user_gender='male')
    TweetBinderPostFactory(date='2020-10-10 00:00:00+00:00', user_gender='female',)
    TweetBinderPostFactory(date='2021-10-10 00:00:00+00:00', user_gender='undefined')
