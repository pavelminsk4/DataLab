...
class ContentVolumeTopLanguagesWidgetTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(language='En', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(language='Sp', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(language='En', date='2021-10-10T00:00:00Z')
