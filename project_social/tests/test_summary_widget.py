...
class SummaryWidgetTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(count_totalretweets='1', count_favorites='1', count_replies='1', language='En', user_name='First_name', country='USA', sentiment='neutral')
        TweetBinderPostFactory(count_totalretweets='2', count_favorites='2', count_replies='2', language='Sp', user_name='Second_name', country='England', sentiment='positive')
