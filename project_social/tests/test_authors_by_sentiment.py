...
class AuthorsByLocationTests(APITestCase):
  def test_response_list(self):
    ...
    TweetBinderPost.objects.create(post_id='1', count_retweets='1', count_favorites='1', count_replies='1', language='En', user_name='First_name', user_alias='@user1',
                                   locationString='USA', sentiment='neutral', text='First twitter post', date=datetime(2020, 10, 10), creation_date=datetime(2020, 10, 10))
    TweetBinderPost.objects.create(post_id='2', count_retweets='2', count_favorites='2', count_replies='2', language='Sp', user_name='Second_name', user_alias='@user2',
    ...
    TweetBinderPost.objects.create(post_id='3', count_retweets='2', count_favorites='2', count_replies='2', language='En', user_name='Second_name', user_alias='@user3',
    ...
    TweetBinderPost.objects.create(post_id='4', count_retweets='2', count_favorites='2', count_replies='2', language='En', user_name='Second_name', user_alias='@user4',
    ...
    res = [
            {'sentiment': 'positive', 'user_count': 3},
            {'sentiment': 'neutral', 'user_count': 1}
          ]
