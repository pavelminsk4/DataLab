...
class ContentVolumeTopAuthorsWidgetTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(user_name='First', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(user_name='Second', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(user_name='Third', date='2021-10-10T00:00:00Z')
