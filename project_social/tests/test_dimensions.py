...
class DimensionsTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(user_name='First', language='En', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(user_name='Second', language='Sp', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(user_name='Third', language='En', date='2021-10-10T00:00:00Z')
