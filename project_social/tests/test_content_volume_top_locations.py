...
class ContentVolumeTopLocationsWidgetTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(country='USA', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(country='England', date='2020-10-10T00:00:00Z')
        TweetBinderPostFactory(country='USA', date='2021-10-10T00:00:00Z')
