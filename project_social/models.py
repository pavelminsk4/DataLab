...
def create_social_widget_description(sender, instance, created, **kwargs):
  if created:
    ...
    wd9.save()
    wd10 = SocialWidgetDescription.objects.create(title='Sentiment', default_title='Sentiment')
    wd10.save()
    wd11 = SocialWidgetDescription.objects.create(title='Gender volume', default_title='Gender volume')
    wd11.save()
    wd12 = SocialWidgetDescription.objects.create(title='Sentiment number of results', default_title='Sentiment number of results')
    wd12.save()
    wd13 = SocialWidgetDescription.objects.create(title='Sentiment authors', default_title='Sentiment authors')
    wd13.save()
    wd14 = SocialWidgetDescription.objects.create(title='Sentiment locations', default_title='Sentiment locations')
    wd14.save()
    wd15 = SocialWidgetDescription.objects.create(title='Sentiment languages', default_title='Sentiment languages')
    wd15.save()
    wd16 = SocialWidgetDescription.objects.create(title='Sentiment by gender', default_title='Sentiment by gender')
    wd16.save()
