...
urlpatterns = [
    ...
    path("workspaces/", views.WorkspaceAccountAnalysisList.as_view(),
         name="account_analysis_workspaces_list"),
    path("workspaces/create/", views.WorkspaceAccountAnalysisCreate.as_view(),
         name="account_analysis_workspaces_create"),
    path("workspaces/update/<int:pk>/", views.WorkspaceAccountAnalysisUpdate.as_view(),
    ...
    path("profile_timeline_widget/<int:pk>/<int:widget_pk>",
         views.profile_timeline_widget, name="profile_timeline_widget"),
    path("most_frequent_post_types_widget/<int:pk>/<int:widget_pk>",
         views.most_frequent_post_types_widget, name="most_frequent_post_types_widget"),
    path("most_engaging_post_types_widget/<int:pk>/<int:widget_pk>",
         views.most_engaging_post_types_widget, name="most_engaging_post_types_widget"),
    ...
    # =======Profile Handle======
    path('list_of_profile_handle', views.list_of_profile_handle,
         name='list_of_profile_handle'),
]
