# Generated by Django 4.0.6 on 2023-05-10 12:37
...
def populate_new_columns(apps, schema_editor):
    ...
    for i in wl:
        wd = AccountAnalysisWidgetDescription.objects.create(title='Top hashtags', default_title='Top hashtags')
        wd.save()
        i.top_hashtags = wd
        i.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account_analysis', '0011_accountanalysiswidgetslist_optimal_post_length'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='top_hashtags',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='top_hashtags', to='account_analysis.accountanalysiswidgetdescription'),
        ),
