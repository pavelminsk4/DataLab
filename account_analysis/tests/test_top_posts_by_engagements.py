...
class TopPostsByEngagementsWidgetTests(APITestCase):
    ...
    def test_response_list(self):
        ...
        res = [
                {'type': 'retweet', 'text': 'Fourth twitter post', 'sentiment': 'neutral', 'engagement': 4, 'ENGMT Rate': 0.04, 'date': 'Oct 10, 2020 12:00 AM'}, 
                {'type': 'retweet', 'text': 'First twitter post', 'sentiment': 'neutral', 'engagement': 2, 'ENGMT Rate': 0.02, 'date': 'Oct 10, 2020 12:00 AM'}, 
                {'type': 'reply', 'text': 'Second twitter post', 'sentiment': 'neutral', 'engagement': 2, 'ENGMT Rate': 0.02, 'date': 'Oct 10, 2020 12:00 AM'}, 
                {'type': 'tweet', 'text': 'Third twitter post', 'sentiment': 'neutral', 'engagement': 2, 'ENGMT Rate': 0.02, 'date': 'Oct 10, 2020 12:00 AM'}
              ]
