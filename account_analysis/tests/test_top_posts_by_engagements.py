...
class TopPostsByEngagementsWidgetTests(APITestCase):
    ...
    def test_response_list(self):
        ...
        res = [
                {'type': 'retweet', 'text': 'Fourth twitter post', 'sentiment': 'neutral', 'engagements': 4, 'engmt_rate': 4.00, 'date': 'Oct 10, 2020 12:00 AM'},
                {'type': 'retweet', 'text': 'First twitter post', 'sentiment': 'neutral', 'engagements': 2, 'engmt_rate': 2.00, 'date': 'Oct 10, 2020 12:00 AM'},
                {'type': 'reply', 'text': 'Second twitter post', 'sentiment': 'neutral', 'engagements': 2, 'engmt_rate': 2.00, 'date': 'Oct 10, 2020 12:00 AM'},
                {'type': 'text', 'text': 'Third twitter post', 'sentiment': 'neutral', 'engagements': 2, 'engmt_rate': 2.00, 'date': 'Oct 10, 2020 12:00 AM'}
              ]
