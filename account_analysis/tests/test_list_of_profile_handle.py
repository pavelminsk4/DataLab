...
class ListOfProfileHandleTests(APITestCase):
    def test_response_list(self):
        TweetBinderPostFactory(
            count_totalretweets='1', count_favorites='1', count_replies='1', language='En', user_alias='First_name', country='USA', sentiment='neutral',
            text='First twitter post', type=['original', 'reply', 'retweet'], date="2022-10-10T00:00:00Z", creation_date="2022-10-10T00:00:00Z"
        )
        TweetBinderPostFactory(
            count_totalretweets='1', count_favorites='3', count_replies='1', language='En', user_alias='First_name', country='USA', sentiment='neutral',
        ...
        TweetBinderPostFactory(
            count_totalretweets='2', count_favorites='2', count_replies='2', language='Sp', user_alias='Second_name', country='England', sentiment='positive',
        ...
        results = {
            ...
            'num_profiles': 2,
            'profiles': [
                {'user_alias': 'First_name', 'user_picture': None},
