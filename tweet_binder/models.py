...
def add_post_to_database(data_tweets):
  ...
  for tweet in data_tweets:
    new_tweet = {
                ...
                'sentiment_vote': tweet['sentiment']['vote'] if tweet['sentiment']['vote'] != 'undefined' else 'neurtal', 
                'sentiment': tweet['sentiment']['vote'] if tweet['sentiment']['vote'] != 'undefined' else 'neurtal', 
                'source': tweet['source'],
                'text': tweet['text'],
                'type': tweet['type'],  
